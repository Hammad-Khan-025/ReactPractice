    ...
    <div className="flex flex-col justify-center items-center bg-gray-200 min-h-screen tracking-wider py-5">
      ...
      <div className="shadow-lg p-8 bg-white rounded-md mt-4 w-80 sm:w-[500px] mx-3">
        <div className="flex flex-col justify-center items-center relative">
          <img
            src={`../images/10Review-images/${image}`}
          ...
          <p className="py-5 text-gray-500 text-justify">
            ...
            <button className="text-blue-500 font-semibold focus:ring-1 px-1 rounded-lg" onClick={toggle}>
              {readMore? "Show Less": "Read More"}
            </button>
          </p>

          <div className="flex gap-5">
            <button className="text-blue-500 border-blue-500 border rounded hover:bg-blue-500 hover:text-white p-2 active:bg-blue-900 transition-colors" onClick={prevBtn}>
              <FaChevronLeft />
            </button>
            <button className="text-blue-500 border-blue-500 border rounded hover:bg-blue-500 hover:text-white p-2 active:bg-blue-900 transition-colors" onClick={nextBtn}>
              <FaChevronRight />
            </button>
          </div>
